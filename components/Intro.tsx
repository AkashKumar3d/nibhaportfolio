...
import five from "@/public/WhatsApp Image 2025-09-13 at 11.10.14 PM.jpeg";
...
const Intro = () => {
    ...
    return (
        <section ref={ref} id='home' className='mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]'>
            <div className='flex items-center justify-center'>
                <div className='relative'>
                    <motion.div initial={{ opacity: 0, scale: 0 }} animate={{ opacity: 1, scale: 1 }} transition={{ type: "tween", duration: 0.2 }}>
                        <Image src={five} alt='Akash_Singh' width='192' height='192' quality='95' priority={true} className='h-24 w-24 rounded-full object-cover border-[0.35rem] border-white shadow-xl' />
                    </motion.div>
            ...
            >
                <span className="font-bold">Hello, I'm Nibha.</span> I'm a{" "}
                <span className="font-bold">Excutive Frontend  developer</span> with{" "}
                <span className="font-bold">0.6 year</span> of experience. I enjoy
                building <span className="italic">Web Applications </span>. My focus is{" "}
                <span className="underline">React,  javaScript, Html , Css, redux , github</span>.
            </motion.p>
            <motion.div
            ...
            >
                ...
                <a
                    ...
                    href="https://www.linkedin.com/in/nibha-barnwal-2887ab38b/"
                    target="_blank"
                >
                    <BsLinkedin />
                </a>
                ...
                <a
                    ...
                    href="https://github.com/wellNibha2002"
                    target="_blank"
                >
                    <FaGithubSquare />
                </a>
